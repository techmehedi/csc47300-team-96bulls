class DashboardSystem {
    ...
    mapSupabaseUser(user) {
        ...
        return {
            ...
            accountType: meta.accountType || meta.role || 'user'
        };
    }
    ...
    updateGoals() {
        ...
        if (goalItems[0]) {
            ...
            if (progressText)
                progressText.textContent = `${totalSolved}/50`;
        ...
        if (goalItems[1]) {
            ...
            if (progressBar)
                progressBar.style.width = `${progress}%`;
            if (progressText)
                progressText.textContent = `${currentStreak}/${targetStreak}`;
        ...
        if (goalItems[2]) {
            ...
            if (progressBar)
                progressBar.style.width = `${progress}%`;
            if (progressText)
                progressText.textContent = `${currentAccuracy}%`;
    ...
    setupErrorHandling() {
        ...
        if (window.dashboardErrorHandlerAdded)
